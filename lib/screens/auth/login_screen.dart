...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _handleGoogleSignIn() async {
    ...
    final result =
    await _authService.signInWithGoogle(role: 'donor');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // ✅ FIX: Make the complete Stack fill the whole screen
      body: Stack(
        fit: StackFit.expand,
        children: [
          // =========================================================
          ...
          Positioned.fill(
            child: Container(
              ...
              child: Image.asset(
                ...
                // Keep fallback only if image path has an issue
  ...
  Widget _buildInputField({
    ...
    return TextFormField(
      ...
      obscureText:
      isPassword ? _isPasswordHidden : false,
